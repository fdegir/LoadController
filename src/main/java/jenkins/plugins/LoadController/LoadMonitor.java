 ...
 */
public class LoadMonitor extends NodeMonitor {
    ...
    public static final AbstractNodeMonitorDescriptor<String> DESCRIPTOR = new AbstractNodeMonitorDescriptor<String>() {
        ...
        /** {@inheritDoc} */
        public LoadMonitor newInstance(StaplerRequest req, JSONObject formData) throws FormException {
    ...
    static final class MonitorTask implements Callable<String, RuntimeException> {
        ...
        */
        public String call() {
            ...
            return String.format("%02.2f", opsysMXbean.getSystemLoadAverage());
        }
    }
}
